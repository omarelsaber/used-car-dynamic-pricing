        ...
        if predict_button:
            if not input_data["name"] or input_data["name"].strip() == "":
                ...
                with placeholder.container():
                    ...
                    st.markdown("<h3 style='text-align: center; color: #667eea;'>🤖 AI Analyzing...</h3>", unsafe_allow_html=True)
                    st.markdown('</div>', unsafe_allow_html=True)
            ...
            st.markdown("<h3 style='text-align: center; color: #FFFFFF;'>👈 Enter car details and click Predict</h3>", unsafe_allow_html=True)
            st.markdown('</div>', unsafe_allow_html=True)
